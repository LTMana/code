...
@private
    ...
    NSString        *name;          //...记录名称
    NSString        *adcode;            //...adcode
    NSString        *dataType;          //...dataType
    NSString        *resultType;        //...resultType
    CNMKGeoPoint    coordinate;     //...坐标，用于导航
    CNMKGeoPoint    coordinate_dis; //...显示坐标，用于poi搜索
    NSString        *addr;          //...地址信息
    NSString        *ctlg;          //...分类代码
    NSString        *tel;           //...电话号码
    double          score;          //...分数
...
@property (nonatomic, copy) NSString        *adcode;            //...adcode
@property (nonatomic, copy) NSString        *dataType;          //...dataType
@property (nonatomic, copy) NSString        *resultType;        //...resultType
@property (nonatomic)       CNMKGeoPoint    coordinate;     //...坐标，用于导航
@property (nonatomic)       CNMKGeoPoint    coordinate_dis; //...显示坐标，用于poi搜索
...
@property (nonatomic)       double          score;          //...分数
...
@private
    ...
    NSInteger       clistcnt;       //...坐标个数
    CNMKGeoPoint    *clist;         //...坐标列
    CNMKGeoPoint    *clistValue;    //...坐标值
}

@property (nonatomic)       double          dist;           //...分段长度
...
@property (nonatomic)       NSInteger       clistcnt;       //...坐标个数
@property (nonatomic)       CNMKGeoPoint    *clist;         //...坐标列
@property (nonatomic)       CNMKGeoPoint    *clistValue;    //...坐标值
...
@property (nonatomic)           float           distsum;    //...总里程
